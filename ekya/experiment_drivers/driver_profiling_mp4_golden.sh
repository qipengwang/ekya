...
# Bellevue_Bellevue_NE8th__2017-09-10_18-08-23_0.5fps
    ...
    # for CITY in Bellevue_150th_Eastgate__2017-09-10_18-08-24_0.5fps Bellevue_150th_Eastgate__2017-09-10_21-08-28_0.5fps Bellevue_150th_Eastgate__2017-09-11_00-08-29_0.5fps Bellevue_150th_Eastgate__2017-09-11_03-08-30_0.5fps Bellevue_150th_Eastgate__2017-09-11_06-08-30_0.5fps Bellevue_150th_Eastgate__2017-09-11_09-08-31_0.5fps Bellevue_150th_Eastgate__2017-09-11_14-08-31_0.5fps Bellevue_150th_Eastgate__2017-09-11_15-08-33_0.5fps; do
    ...
    CUDA_VISIBLE_DEVICES=3 python driver_multicity.py \
             --scheduler profiling \
             --cities ${CITY} \
             --log-dir /data2/zxxia/ekya/results/${DATASET_NAME}_outputs/human_label_logs/ \
             ...
             --profiling-mode \
             --profile-write-path /data2/zxxia/ekya/results/${DATASET_NAME}_outputs/human_label_profiles_sampled_${START_TASK}_${TERMINATION_TASK}/ \
